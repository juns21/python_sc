...
print("2", soup.select_one("ul#ac-list > li:nth-of-type(4)").string)
print("3", soup.select("ul#ac-list > li[data-lo='cn']")[0].string)
print("4", soup.select("ul#ac-list > li.alcohol.high")[0].string)
